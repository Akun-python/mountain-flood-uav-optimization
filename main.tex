...
26 架次，其中 A 型 12、B 型 7、C 型 7，完工时间约 115\,min，总能耗 70.86\,kWh，
全部 80 箱按各自时限交付，加权迟到为零。相较原遗传算法均衡方案，完工提前约
24\,min（17.3\%）、能耗降低约 6.5\,kWh；若以能耗为先，可选用 21 架次方案
（约 131\,min、62.46\,kWh）。
...
复用：W 点服务时段 778 至 6502\,s，能耗 1.979\,kWh；E 点服务时段 800 至
3774\,s，能耗 1.102\,kWh；N 点服务时段 5594 至 6212\,s，能耗 0.450\,kWh，
中继合计约 3.53\,kWh，回程链路全部可行。协同方案保持 26 架次、运输完工约
115\,min、运输能耗 70.86\,kWh，联合完工 6921\,s（约 115.4\,min）由中继 1 返场
决定，较原协同基线 6960\,s 提前约 39\,s；全部 80 箱按时交付、加权迟到为零，
覆盖盲区为零。
