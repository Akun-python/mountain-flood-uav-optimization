...
26 架次，其中 A 型 12、B 型 7、C 型 7，完工时间约 116\,min，总能耗 70.71\,kWh，
全部 80 箱按各自时限交付，加权迟到为零。相较原遗传算法均衡方案，完工提前约
23\,min（16.6\%）、能耗降低约 6.6\,kWh；若以能耗为先，可选用 21 架次方案
（约 131\,min、62.46\,kWh）。
...
121\,min、运输能耗 70.71\,kWh，全部 80 箱按时交付、加权迟到为零，覆盖盲区为零。
...
W 点最长连续服务 95\,min，占单架次能源上限对应时长约 140\,min 的 68.3\%，
