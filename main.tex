...
一致零违例），凡"捎带"结算者一律判不可行。选取零迟到的精炼冠军方案：25 架次，
其中 A 型 12、B 型 7、C 型 6，完工时间约 109.5\,min（6571.4\,s），总能耗
69.77\,kWh，全部 80 箱按各自时限、投送至各自指定服务区交付，加权迟到为零。
...
冠军（25 架次、完工 6571.4\,s）沿航线审核得到 1394 个需中继采样点，初始布设
即实现全覆盖（覆盖不良为零）、运输无需平移。以该方案为运输层输入，两架中继按
时间分片复用：W 点单班，服务时段 686 至 6777\,s（能耗 2.091\,kWh）；E 点
服务时段 760 至 3101\,s，能耗 0.909\,kWh；N 点服务时段 2562 至 3289\,s，
能耗 0.483\,kWh，中继合计约 3.48\,kWh，回程链路全部可行，各班能耗均低于
