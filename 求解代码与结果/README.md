...
├── 结果/          当前冠军结果 JSON 与进化归档（进化_v3 … 进化_v22）
...
- 问题三/问题四持续优化实验（多框架对比、严格复核）见 `结果/进化_v17/README.md`；问题二尾部修复与联合完工最优性验证（v19）见 `结果/进化_v19/README.md`；问题二能耗边界与中继安全筛查（v20）见 `结果/进化_v20/README.md`；中继充电模型条件修正（v21）见 `结果/进化_v21/README.md`；W 窗口末端收口攻击（v22）见 `结果/进化_v22/README.md`。
