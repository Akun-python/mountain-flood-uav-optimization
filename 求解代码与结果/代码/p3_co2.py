...
# 位置（v17 余量约束优化：零覆盖缺口 + 回程可行 + 悬停离地 ≤300 m +
# 最紧接入余量 ≥1 dB 下能耗最低；W 已至余量极限保持官方，E/N 采纳
# 框架 D 结果，中继能耗 3.545→3.417 kWh，严格复核 cover_bad=0、机器惩罚 0）
P_W = (109.2103, 23.047134, 676.5)
P_E = (109.268918, 23.012732, 650.0)
P_N = (109.234314, 23.059248, 600.0)
AREA_POS = {}
